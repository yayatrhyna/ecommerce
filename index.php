		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Cashback</h4>
						</div>
					</div>	
					<h6 class="text">Uang Kembali.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Free Give</h4>
						</div>
					</div>
					<h6 class="text">Cashback ++</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Semua Unit Diskon 20 % </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
